...
export class AboutUs extends Component {
  ...
  head() {
    return (
      <Helmet bodyAttributes={{ class: "aboutUs" }}>
        <title>AboutUs - Yan Chim Kee</title>
      </Helmet>
    );
  }
        ...
        <Container className="aboutUs">
          <Row className="justify-content-md-center">
            ...
            <p>
              ...
              初時沿街叫賣,逐漸廣受歡迎, 人皆以 {"亞沾"}{" "}
              呼之.其後便以甄沾記之名,在港粵開設店鋪售賣其出品.
              行銷南中國及東南亞及歐美有華人社區之城市.
              .三十年代由其子甄彩源接手，並於一九五八年在香港黃竹坑開設
            ...
            <p>
              Yan Chim Kee was founded by Mr. Yan Lun Lap in 1915 after learning
              how to make coconut candies in Malaysia. Started selling candies
              as a hawker,
            </p>
              ...
              {timelines.map((timeline, index) => (
                <Row className="justify-content-md-center" key={index}>
                  ...
                  >
                    <Col
                      ...
                      style={{
                        ...
                        marginBottom:
                          index === timelines.length - 1 ? "120px" : null
                      }}
                    >
                      <Row md={12} style={{ marginTop: "20px" }}>
                        <Col md={{ order: index % 2 ? 2 : 1, span: 8 }} sm={12}>
                          <Image
                            className={index % 2 ? "float-right" : "float-left"}
                            src={`/images/timeline/${timeline.image}`}
                            thumbnail
                          />
                        </Col>
                  ...
                  <Col
                    ...
                    style={{
                      borderRight: index % 2 ? "6px #891a14 solid" : null
                    }}
                  />
                </Row>
              ))}
